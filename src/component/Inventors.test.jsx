...
import { getAllInventors } from '../lib/dataLoader';
...
describe('Inventors discovery', () => {
  it('filters inventors by search text and era', async () => {
    ...
    await user.selectOptions(screen.getByRole('combobox', { name: /^era$/i }), '1700s');
    ...
    expect(getAllInventors().length).toBeGreaterThan(totalCards - 1);
  });
});
